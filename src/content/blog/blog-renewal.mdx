...
かつては[rehype-mermaidjs](https://github.com/remcohaszing/rehype-mermaidjs)を使っていた。現在は[@beoe/rehype-d2](https://github.com/stereobooster/beoe/tree/main/packages/rehype-d2)に移行。
